...
#### 2. The "Brain" Phase (Building the Crew)  

This is where you use CrewAI. You need to define your "Team of Agents."  

    Action: Create a script (agents.py) where you define your agents.  

    The "Vibe": You are describing roles to the AI.  

    Prompt for ChatGPT: "Using CrewAI and Gemini 1.5 Flash, write a script that defines two agents: 1. A 'News Researcher' who fetches headlines about [Specific Topic] and 2. A 'Market Analyst' who compares those headlines to current Oil prices and provides a Risk Score. Include a 'Task' for each."  
...
Agents are useless without "Tools."  
    ...
    Prompt for ChatGPT: "Write a Python function using the newsapi-python library that searches for articles from the last 24 hours. Then, show me how to wrap this function as a 'Tool' that a CrewAI agent can use."  
...
Now you need to make this accessible to a browser.  
    ...
    Prompt for ChatGPT: "Create a FastAPI endpoint called /analyze that, when called, runs my CrewAI sequence and returns the summary and risk score as a JSON object."  
